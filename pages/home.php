    ...
    <header>
        ...
        <nav class="navbar navbar-light justify-content-between">
            ...
            <form class="form-inline">
                ...
                <button class="btn btn-outline-warning  " type="submit" ><a href="../index.php">Atsijungti</a></button>
            </form>
        </nav>
        <hr>
    </header>

    <h2 class="alert-success text-center py-4">Čia yra jūsų krepšelis: </h2>
